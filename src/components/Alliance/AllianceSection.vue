<template>
  <div class="contents">
    <div class="tag__list">
      <button
        v-for="item in allianceName"
        :key="item.name"
        @click="updateAllianceTag(item.name)"
    ...
    <div class="info-section">
      <div v-if="allianceTag === '멤버십 안내'" class="box_a">
        ...
        <div class="tier">
          ...
          <div class="caution">
            ...
            &nbsp;
            <p>
              - 가입즉시 적립금 사용 가능합니다. - 회원가입, 후기 작성 시
              적립금은 자동으로 적립됩니다.<br />
              - 카카오플러스 친구 등록 후 아이디를 알려주시면 적립됩니다.<br />
              - 어플 다운로드 후 로그인 시 자동으로 적립됩니다.
            </p>
            &nbsp;
            <h3>※ 등급별 혜택 유의사항</h3>
            &nbsp;
            <p>
              - 적립금 혜택은 결제금액 대비로 계산되어 적립됩니다.<br />
              - 배송완료 후 등급 혜택이 적용됩니다.<br />
              - 모든 적립금은 1년 후 자동 소멸됩니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div v-else-if="allianceTag === '1:1 문의'">
        <div class="unquiryBtn">
          <a
            href="https://thegmpharm.co.kr/member/login.html?returnUrl=%2Fboard%2Fconsult%2Flist.html%3Fboard_no%3D9"
            target="_blank"
          >
      ...
      <div v-else-if="allianceTag === '기업제휴 문의'">
        <div class="unquiryBtn">
          <a
            href="https://docs.google.com/forms/d/e/1FAIpQLScBkB4OzNmfpt5WbyIQtgRoksr8x8aX1GFwJSjkyx0KWNFD6w/viewform?vc=0&c=0&w=1&flr=0"
            target="_blank"
          >
            <button>기업제휴 문의하기</button>
          </a>
        </div>
      </div>
  ...
  data() {
    return {
      ...
      questionTag: [
        {
          name: "회원·정보",
          image: "./image/faq_icon01.png",
          image1: "./image/faq_icon01.png",
          image2: "./image/faq_icon01_h.png",
        },
        {
          name: "주문·결제",
          image: "./image/faq_icon02.png",
          image1: "./image/faq_icon02.png",
          image2: "./image/faq_icon02_h.png",
        },
        {
          name: "배송관련",
          image: "./image/faq_icon03.png",
          image1: "./image/faq_icon03.png",
          image2: "./image/faq_icon03_h.png",
        },
        {
          name: "취소·반품·교환·환불",
          image: "./public/image/faq_icon04.png",
          image1: "./image/faq_icon04.png",
          image2: "./image/faq_icon04_h.png",
        },
        {
          name: "쿠폰·적립금·이벤트",
          image: "./public/image/faq_icon05.png",
          image1: "./image/faq_icon05.png",
          image2: "./image/faq_icon05_h.png",
        },
      ],
      faqItems: [
        {
          ...
          subItems: [
            {
              content:
                "적립금은 주문하신 상품이 배달완료로 확인이 되면 자동으로 지급됩니다.",
            },
          ],
        },
        {
          ...
          subItems: [
            {
              content:
                "회원가입시 할인쿠폰을 받으실 수 있으며, 회원 등급별로 적립금, 추가할인 혜택을 받으실 수 있습니다.",
            },
          ],
        },
        {
          ...
          subItems: [
            {
              content:
                "홈페이지 우측 상단 [로그인> 아이디/비밀번호 찾기] 버튼을 눌러 아이디 혹은 비밀번호를 찾으실 수 있습니다. ",
            },
        ...
        },
        {
          ...
          subItems: [
            {
              content:
                "1:1 문의/ 고객센터 1811-7835로 연락주시면 회원 본인 확인 후 도와 드리겠습니다.",
            },
          ],
        },
      ],
      faqItems2: [
        {
          ...
          subItems: [
            {
              content:
                "네. 가능합니다. 결제방법은 무통장입금 또는 카드결제로 가능합니다.고객센터 1811-7835 로 전화해 주시면 친절히 도와드리겠습니다.결제계좌안내[ IBK기업은행 / (주)지엠팜 / 357-078344-01-046 ]",
            },
          ],
        },
        {
          ...
          subItems: [
            {
              content:
                "주문자와 입금자 성함이 다를 때는 입금 확인이 어렵습니다.1:1문의게시판에 주문자 성함과 입금 자 성함을 남겨 주시거나 고객센터 1811-7835로 문의해 주세요.",
            },
          ],
        },
        {
          ...
          subItems: [
            {
              content:
                "결제 완료 후 할부로 변경하시고자 하는 경우엔 고객센터 1811-7835로 문의해 주세요.",
            },
          ],
        },
        {
      ...
      faqItems3: [
        {
          ...
          subItems: [
            {
              content:
                "배송완료전인 결제완료상태에서는 배송지수정이 가능합니다.배송완료 상태에서는 주소지 변경이 불가능하므로 1:1 문의게시판이나 고객센터 1811-7835로 요청 주시면 빠르게 도와드리겠습니다.",
            },
          ],
        },
        {
          ...
          subItems: [
            {
              content:
                "평일 오후 3시 이전에 주문하신 제품은 당일 출고됩니다.(공휴일제외)",
            },
          ],
        },
        {
          ...
          subItems: [
            {
              content:
                "주문하신 상품은 결제 완료 후 평균 1~2일 이내에 배송이 됩니다. (연휴 및 주말은 제외 하며, 배송 지역마다 차이가 있을 수 있습니다.)단, 구정 추석 연휴 등 택배 물량이 많이 발생하는 경우, 폭설, 폭우 등 천재지변이 일어나는 경우 배송이 지연될 수 있습니다.도서산간 지방의 경우 1~5일 정도 지연될 수 있습니다.",
            },
          ],
        },
        {
          ...
          subItems: [
            {
              content:
                "네 해외 배송도 가능하며, 우체국 EMS 국제특급 배송으로 배송해드리고 있습니다.해외지역에 따라 별도의 배송비가 추가됩니다.주문 방법은 결제 배송 지 입력시에 우편번호 찾기에서 ‘해외’ 를 입력하시고 검색을 누르신 다음 나머지 주소란에 해외 주소지를 적어 주시면 됩니다.기타문의 사항은 1:1 게시판에 남겨 주시면 신속히 답변 드리겠습니다.",
            },
          ],
        },
      ],
      faqItems4: [
        {
          ...
          subItems: [
            {
              content:
                "미개봉 시 단순 변심에 의한 반품은 구입일로부터 14일 이내에만 가능하며, 왕복 택배비 6,000원을 제외한 금액만 환불됩니다. (계좌 이체일 경우 현금 6,000원을 따로 입금해 주셔야 합니다.)",
            },
          ],
        },
      ],
      faqItems5: [
        {
          ...
          subItems: [
            {
              content:
                "구매 시 적립금 사용금액 한도는 없습니다.단, 이벤트 제품에 해당될 경우 적립금 사용이 불가 할 수 있습니다.",
            },
          ],
        },
      ],
