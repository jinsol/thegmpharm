        ...
        <div class="inBox">
          <p>
            <span
              ...
              쇼핑몰 운영형태에 따른 수정이 필요합니다.</span
            >
            <span
              >쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한
              내용을 반영하여 사용하시기 바랍니다.</span
            >
            &nbsp;
            <span
              >(주)지엠팜은 (이하 "회사"는) 고객님의 개인정보를 중요시하며,
              "개인정보 보호법" 등 관련 법령을 준수하고 있습니다.</span
            >
            <span
              >회사는 개인정보처리방침을 통하여 고객님께서 제공하시는 개인정보가
              어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한
              조치가 취해지고 있는지 알려드립니다.</span
            >
            &nbsp;
            ...
            <span
              >o 서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록,
            ...
            <span
              ...
              해지일로부터 oo년간 회원의 정보를 보유할 수 있습니다.</span
            >
            &nbsp;
            <span>나. 관련 법령에 의한 정보 보유 사유</span>
            <span
              >전자상거래등에서의소비자보호에관한법률 등 관계법령의 규정에
              의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서
              정한 일정한 기간 동안 회원정보를 보관합니다.</span
            >
            ...
            <span
              ...
              기간 저장된 후 파기되어집니다.</span
            >
            <span
              >별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는
              보유되어지는 이외의 다른 목적으로 이용되지 않습니다.</span
            >
            <span>o 파기방법</span>
            <span
            ...
            >
            <span
              >o 위탁 대상자 :롯데택배, CJ대한통운, 우체국,
              ㈜스냅컴퍼니(알림전송수탁업체 : 루나소프트(재위탁: 비즈톡
              주식회사))</span
            >
            <span
              >o 위탁업무 내용 :상품배송, 게시판 시스템 및 마일리지 시스템
              구축/유지/보수</span
            >
            <span
              >o 위탁 대상자 :토스페이먼츠, 네이버페이, KG모빌리언스,
              카카오페이, 페이코</span
            >
            ...
            >
            <span
              >o 위탁업무 내용 : 상품배송, 고객 개인정보(이름, 아이디,
              휴대전화번호)를 통해 신규 서비스(제품) 개발 및 맞춤 서비스 제공,
              이벤트 및 광고성 정보 및 참여기회 제공</span
            >
            <span>o 위탁 대상자 : (주)루나소프트</span>
            <span>o 개인정보제공처 : 주식회사 카카오</span>
            <span
              >o 위탁업무 내용 : 카카오톡 알림톡(정보성 메세지) 발송 업무</span
            >
            <span>o 위탁 대상자 : ㈜스냅컴퍼니</span>
            <span
              >o 알림전송수탁업체 : 주식회사 루나소프트(재위탁 : 비즈톡
              주식회사)</span
            >
            <span
              >o 위탁업무 내용 : 고객 개인정보(이름, 아이디, 휴대전화번호)를
              통해 신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성
              정보 및 참여기회 제공</span
            >
            &nbsp;
            ...
            <span
              ...
              수정할 수 있으며 가입해지를 요청할 수도 있습니다.</span
            >
            <span
            ...
            <span
              ...
              제3자에게 지체없이 통지하여 정정이 이루어지도록 하겠습니다.</span
            >
            <span
              >o 회사는 이용자의 요청에 의해 해지 또는 삭제된 개인정보는 "회사가
              수집하는 개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고
              그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.</span
            >
            &nbsp;
            <span
            ...
            <span
              >1. 회원과 비회원의 접속 빈도나 방문 시간 등을 분석, 이용자의
              취향과 관심분야를 파악 및 자취 추적, 각종 이벤트 참여 정도 및 방문
              회수 파악 등을 통한 타겟 마케팅 및 개인 맞춤 서비스 제공</span
            >
            <span
              >2. 귀하는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서,
            ...
            <span
              >1. 쿠키 설정을 거부하는 방법으로는 회원님이 사용하시는 웹
              브라우저의 옵션을 선택함으로써 모든 쿠키를 허용하거나 쿠키를
              저장할 때마다 확인을 거치거나, 모든 쿠키의 저장을 거부할 수
              있습니다.</span
            >
            <span
              >2. 설정방법 예(인터넷 익스플로어의 경우) : 웹 브라우저 상단의
              도구 > 인터넷 옵션 > 개인정보</span
            >
            <span
              >3. 단, 귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에
              어려움이 있을 수 있습니다.</span
            >
            &nbsp;
